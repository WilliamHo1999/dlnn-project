...
if __name__ == "__main__":
    ...
    model_path = 'models/resnet_100_imagenet_fine_tuned.pt'
    ...
    trainer_fine_tune = Trainer(resnet, loss_fn, classes, training_params, DEVICE, num_epochs = 10, model_name = 'resnet_100_imagenet_adv_training_larger_lr_new_scheduler_larger_ball', save_model = True, model_dir = 'models', adversarial_training = True, adversarial_attack = pgd, custom_scheduler = True)
